...
public class Helpers {
  ...
  public static BufferedImage[] getAnimations(String path) {
  ...
  public static boolean canMove(Player player, float x, float y, int[][] lvlData) {
    ...
    //     if (!isSolid(x + width, y, lvlData) && (!isSolid(x + width, y + height, lvlData))) {
    //       return true;
    //     }
    //     break;
    //   case JUMP:
    ...
    //     if (!isSolid(x, y + height, lvlData) && (!isSolid(x + width, y + height, lvlData))) {
    //       return true;
    //     }
    //     break;
    //   default:
    ...
    if (x < 0 || x >= GAME_WIDTH || y < 0 || y >= GAME_HEIGHT) {
			return false;
    } else  if (!isSolid(x, y, lvlData) && (!isSolid(x + width, y + height, lvlData)) && (!isSolid(x + width, y, lvlData)) &&  (!isSolid(x, y + height, lvlData))) {
      return true;
    }
